...
def main(cfg: DictConfig):
    ...
    model.save_pretrained(os.path.join(cfg.experiment.save_path, "lora_adapter"))
    # Save the SWAG stats
    torch.save(swag_model.state_dict(), os.path.join(cfg.experiment.save_path, "swag_model.pt"))
    
    print(f"Training finished. Model saved to {cfg.experiment.save_path}")
